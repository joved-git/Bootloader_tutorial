...
int main(void)
{
  ...
  MX_USART2_UART_Init();
  /* USER CODE BEGIN 2 */
  printf("Starting Update Booltoader (v%d.%d)\n", BL_Version[0], BL_Version[1]);
  ...
  printf("Press the Joystick central button to trigger OTA update...\r\n");
...
static void goto_application(void)
{
	...
	HAL_GPIO_WritePin(GPIOE, GPIO_PIN_0, GPIO_PIN_SET);			/* Green led is OFF	*/

	app_reset_handler();										/* Call the reset handler application	*/
}
/* USER CODE END 4 */
